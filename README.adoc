...
* Primary development repository: https://git.ypbind.de/cgit/vmware-horizon-exporter/
* Backup repository: https://github.com/Bobobo-bo-Bo-bobo/vmware-horizon-exporter
